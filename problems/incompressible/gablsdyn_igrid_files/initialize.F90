module gabls_igrid_parameters
    ...
    real(rkind) :: xdim = 400._rkind, udim =8._rkind, timeDim = zero
...
subroutine compute_xdim_udim(inputfile)
    ...
    use gabls_igrid_parameters, only: xdim, udim, timeDim, g, omega, message
    ...
    timeDim = xdim/max(abs(udim),0.0001)
...
subroutine initfields_wallM(decompC, decompE, inputfile, mesh, fieldsC, fieldsE)
    ...
    if(allocated(Tpurt)) deallocate(Tpurt)
