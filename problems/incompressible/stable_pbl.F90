! Stable boundary layer simulation, modified from gabls_igrid.F90
! and from stable_pbl on igridSGS-KSK
...
program stable_pbl
    ...
    call compute_xdim_udim(inputfile)       !<-- Reads the \PHYSICS\ namelist to compute (xdim, udim) from (Ro, Fr)
