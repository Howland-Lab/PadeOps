module convective_igrid_parameters
    ...
    real(rkind), parameter :: xDim = 240._rkind, uDim = 8._rkind !sqrt(3.0_rkind**2+9._rkind**2)
...
contains
    ...
    subroutine setup_diurnalBCs(inputfile)
        ...
        t_geo = data2read(:,1) * 60.d0*60.d0/240.0d0
        G_geo = data2read(:,2)
...
subroutine initfields_wallM(decompC, decompE, inputfile, mesh, fieldsC, fieldsE)
    ...
    integer :: ioUnit
    real(rkind), dimension(:,:,:), pointer :: u, v, w, wC, T, x, y, z, Tpurt
    ...
    real(rkind), dimension(:,:,:), allocatable :: randArr1, randArr2, randArr3, randArr
